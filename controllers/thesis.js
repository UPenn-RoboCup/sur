...
this.addEventListener("load", function () {
	...
	function setFigures() {
		...
		if (!svg_script_el || !tex_done) { return; }
	...
	function loadTex(e) {
		// Load the text
		qwest.get('/md/' + chapter_el.id, {}, {}, function () {this.responseType = 'text'; })
			.success(runMathJax);
		// Load the SVG replacement code
		qwest.get('/snap/' + chapter_el.id + '.js', {}, {}, function () {this.responseType = 'text'; })
			.success(run_svgjs)
			.complete(setFigures);
	}
