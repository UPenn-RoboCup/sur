	...
	*/
	...
	function Robot2(options) {
      ...
      axel: new THREE.Vector3(0, 0, 1)
		...
		var object = loader.load('json/thorop2.json', function(object){
			console.log('object', object);
			scene.add( object );
		});

		/*
		function get_obj(file, cb){
		...
		get_obj('test', function(o){console.log(o)});
		*/
