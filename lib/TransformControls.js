      ...
      var scale_factor = 1000;
			...
			if ( scope.space == "local" ) {
				...
				if ( scope.axis == "XYZ") {
					...
					if ( scope.axis == "X" ) scope.object.scale.x = oldScale.x * ( 1 + point.x / scale_factor );
					if ( scope.axis == "Y" ) scope.object.scale.y = oldScale.y * ( 1 + point.y / scale_factor );
					if ( scope.axis == "Z" ) scope.object.scale.z = oldScale.z * ( 1 + point.z / scale_factor );
		...
		scope.update();
		scope.dispatchEvent( changeEvent );
    scope.dispatchEvent( modifyEvent );
